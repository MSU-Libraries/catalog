...
verbose "test2 \"${MARIADB_ROOT_PASSWORD_FILE2}\""
verbose "test3 \"${MARIADB_ROOT_PASSWORD_FILE3}\""
verbose "test4 \"${MARIADB_ROOT_PASSWORD_FILE4}\""
verbose "test4 $(cat "${MARIADB_ROOT_PASSWORD_FILE}")"
verbose "test5 $(cat "${MARIADB_ROOT_PASSWORD_FILE2}")"
verbose "test6 $(cat "${MARIADB_ROOT_PASSWORD_FILE4}")"
verbose "test7 $(cat "/run/secrets/MARIADB_ROOT_PASSWORD")"
verbose "test8 \"${MARIADB_ROOT_PASSWORD_TEST}\""
