...
verbose "test0 \"${MARIADB_ROOT_PASSWORD}\""
verbose "test1 \"${MARIADB_ROOT_PASSWORD_FILE}\""
verbose "test2 \"${MARIADB_ROOT_PASSWORD_FILE1}\""
verbose "test3 \"${MARIADB_ROOT_PASSWORD_FILE2}\""
verbose "test4 $(cat "${MARIADB_ROOT_PASSWORD_FILE}")"
verbose "test5 $(cat "${MARIADB_ROOT_PASSWORD_FILE1}")"
verbose "test6 $(cat "${MARIADB_ROOT_PASSWORD_FILE2}")"
verbose "test7 $(cat "/run/secrets/MARIADB_ROOT_PASSWORD")"
verbose "debug1 $*"
verbose "debug2 $(grep '^PPid' "/proc/$PID/status")"
