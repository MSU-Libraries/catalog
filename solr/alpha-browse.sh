...
rebuild_databases() {
    ...
    if ! JAVA_HOME=/opt/bitnami/java SOLR_HOME=${ARGS[BUILD_PATH]} SOLR_JAR_PATH=/opt/bitnami/solr VUFIND_HOME=/solr_confs/vufind_libs /solr_confs/index-alphabetic-browse.sh; then
