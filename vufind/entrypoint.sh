...
unset FOLIO_URL FOLIO_USER FOLIO_PASS FOLIO_TENANT FOLIO_REC_ID FOLIO_CANCEL_ID OAI_URL MAIL_HOST MAIL_PORT \
    MAIL_USERNAME MAIL_PASSWORD FEEDBACK_EMAIL FEEDBACK_PUBLIC_EMAIL FEEDBACK_EMAIL_SUBJECT_PREFIX FEEDBACK_PUBLIC_EMAIL_SUBJECT_PREFIX EDS_USER EDS_PASS EDS_PROFILE EDS_ORG \
