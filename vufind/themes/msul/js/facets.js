...
VuFind.register('sideFacets', function SideFacets() {
  ...
  function getHrefWithNewParams() {
    $('form#publishDateFilter .date-fields input').each(function () {
    ...
    currentParams = currentParams.filter(function(obj) { return !globalRemovedParams.includes(obj); });
  ...
  function showLoadingOverlay(e, data) {
    ...
    if (multiFacetsSelection === true) {
      ...
      let addedParams = newParams.filter(function (obj) {
        return !currentParams.includes(obj);
      });
      let removedParams = currentParams.filter(function (obj) {
