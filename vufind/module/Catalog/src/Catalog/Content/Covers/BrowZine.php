 ...
 * @link     https://vufind.org/wiki/development Wiki
 */
class BrowZine extends \VuFind\Content\Covers\BrowZine
{
    /**
    ...
    public function getUrl($key, $size, $ids)
    {
        ...
        // MSU customization: ignore filenames starting with "default-"
        $url = $result['data'][0]['coverImageUrl'] ?? false;
        if ($url && str_starts_with(basename($url), 'default-')) {
            return false;
        }
        return $url;
    }
