<xsl:stylesheet version="1.0"
    ...
    <xsl:param name="institution">Michigan State University</xsl:param>
    <xsl:param name="collection">FOLIO</xsl:param>
    <xsl:param name="id_tag_name">dc:identifier</xsl:param>
    ...
    <xsl:template match="oai_dc:dc">
        <add>
			...
			<xsl:value-of select="*[name()=$id_tag_name]"/>
                ...
                <!-- RECORD FORMAT -->
                <field name="record_format">folio</field>
                ...
                <xsl:if test="dc:date">
                    <field name="publishDate">
                        <xsl:value-of select="substring(dc:date, 2, 4)"/>
                    </field>
