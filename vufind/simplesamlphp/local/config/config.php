...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => 'https://'.getenv('SITE_HOSTNAME').'/simplesamlphp/',
     ...
     * as file locations.
     */
    'certdir' => '${SIMPLESAMLPHP_CUSTOM_DIR}/cert/',
    ...
    */
     ...
     */
    'auth.adminpassword' => file_get_contents('${SIMPLESAMLPHP_ADMIN_PW_FILE}'),
     ...
     */
    'session.duration' => 24 * (60 * 60), // 24 hours.
     ...
     */
    'metadatadir' => '${SIMPLESAMLPHP_CUSTOM_DIR}/metadata',
     ...
     * syntaxes.
     */
    'store.sql.dsn'                 => 'mysql:host=galera;dbname=vufind',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => 'vufind',
    'store.sql.password' => file_get_contents('${MARIADB_VUFIND_PASSWORD_FILE}'),
